...
class SubGolController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('SubGol');
	...
	{
		$model=new SubGol('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SubGol']))
			$model->attributes=$_GET['SubGol'];
	 ...
	 * @return SubGol the loaded model
	 ...
	 * @param SubGol $model the model to be validated
	 */
